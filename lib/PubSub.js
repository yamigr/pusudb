            ...
            try{
                if(this.block){
                    if(this.topics[concatedTopic][socket] !== sock){
                        if(!this.send(this.topics[concatedTopic][socket], { err : null, data : { key : topic, value: payload}})){
                        ...
                        try{
                            if(this.block){
                                if(this.wildcards[card][socket] !== sock){
                                    if(!this.send(this.wildcards[card][socket], { err : null, data : { key : topic, value: payload}})){
