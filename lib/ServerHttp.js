...
class HttpServer extends Utility {
    ...
    */
    ...
    handleQueryCases(req, callback){
        ...
        if(req.params.api.meta === 'stream' || req.params.api.meta === 'count' || req.params.api.meta === 'keys' || req.params.api.meta === 'values' )
        ...
        if(req.method !== 'GET'){
            ...
            req.on('end', () => {
               if(req.headers['content-type'] === 'application/json'){
                    ...
                    if(req.params.api.meta === 'put' || req.params.api.meta === 'update'){
