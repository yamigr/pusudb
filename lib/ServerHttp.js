            ...
            function(done){
                if(self.enableQueryDb(req.url, req.params.api)){
                    self.handelQuery(req, function(err, docs){
                        req.docs = Object.assign(req.docs, req.params.api , docs)
                        if(docs){
    ...
    */
    ...
    handleQueryCases(req, callback){
        ...
        switch(req.method){
            ...
            this.handlerQueryAndPubSub(this.buildPackage(req.params.api.db, req.params.api.meta, req.params.query), function(docs){
                callback(docs)
            })
            break
            case 'POST':
            ...
            this.handlerQueryAndPubSub(this.buildPackage(req.params.api.db, req.params.api.meta, req.body), function(docs){
                callback(docs)
            })
            break
            default:
